...
N - количество прямоугольникв, M - количество точек
Если у нас очень большие входные данные с прямоугольниками, но при этом мало точек, то тут больше подойдет алгоритм перебора (тк N*logN + M*logN > N*M при маленьких M)
Если же много данных и точек и прямоугольников, то алгоритм дерева решит проблему лучше других
